    ...
    variants: [
      {
        ...
        sellingPrice: 3299,
        costPrice: 1500,
        stock<dyad-write path="src/data/mockData.ts" description="Complete realistic catalog of Kurtis, Co-ord sets, Mul cotton and Printed sarees, with coupons and reviews">
import { Product, Coupon, UserReview } from '../types/ecommerce';
...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  {
    id: 'prod-006',
    name: 'Zoya Tiered Peplum Co-ord Set<dyad-write path="src/data/mockData.ts" description="Complete realistic catalog of Kurtis, Co-ord sets, Mul cotton and Printed sarees, with coupons, reviews, and categories">
import { Product, Coupon, UserReview } from '../types/ecommerce';
